...
[![Contributions Welcome](https://img.shields.io/badge/contributions-welcome-brightgreen.svg?style=flat-square\&logo=github)](https://github.com/Corsinvest/awesome-proxmox-ve/issues) ⭐ 1,100 | 🐛 0 | 📅 2026-09-07
[![Stars](https://img.shields.io/github/stars/Corsinvest/awesome-proxmox-ve?style=flat-square\&logo=github)](https://github.com/Corsinvest/awesome-proxmox-ve) ⭐ 1,100 | 🐛 0 | 📅 2026-09-07
[![Forks](https://img.shields.io/github/forks/Corsinvest/awesome-proxmox-ve?style=flat-square\&logo=github)](https://github.com/Corsinvest/awesome-proxmox-ve/fork) ⭐ 1,100 | 🐛 0 | 📅 2026-09-07
...
* [CV4PVE-ADMIN (Web UI)](https://corsinvest.it/cv4pve-admin-proxmox/)
  ...
  [GitHub](https://github.com/Corsinvest/cv4pve-admin) ⭐ 404 | 🐛 3 | 🌐 C# | 📅 2026-08-27
...
* [**CV4PVE-ADMIN**](https://github.com/Corsinvest/cv4pve-admin) ⭐ 404 | 🐛 3 | 🌐 C# | 📅 2026-08-27
...
* [**CV4PVE-VDI**](https://github.com/Corsinvest/cv4pve-vdi) ⭐ 126 | 🐛 3 | 🌐 C# | 📅 2026-07-30
...
* [**CV4PVE-REPORT**](https://github.com/Corsinvest/cv4pve-report) ⭐ 58 | 🐛 2 | 🌐 C# | 📅 2026-06-01
  Export Proxmox VE infrastructure to a navigable Excel report — like RVTools for Proxmox.
* [**CV4PVE-DIAG**](https://github.com/Corsinvest/cv4pve-diag) ⭐ 54 | 🐛 3 | 🌐 C# | 📅 2026-08-31
...
* [PVE-VDIClient](https://github.com/joshpatten/PVE-VDIClient) ⭐ 1,093 | 🐛 44 | 🌐 Python | 📅 2026-04-10 — Lightweight VDI kiosk client for launching Proxmox VE VM consoles.
* [CV4PVE-VDI](https://github.com/Corsinvest/cv4pve-vdi) ⭐ 126 | 🐛 3 | 🌐 C# | 📅 2026-07-30 — Official Corsinvest desktop VDI client for Proxmox VE with SPICE, VNC, RDP and SSH console launchers.
...
* [Pulse](https://github.com/rcourtman/Pulse) ⭐ 6,704 | 🐛 48 | 🌐 Go | 📅 2026-09-13 — Real-time monitoring for Proxmox VE and PBS with guest, storage and backup visibility, alerting, and a multi-client mode for providers.
* [Prometheus Proxmox VE Exporter](https://github.com/prometheus-pve/prometheus-pve-exporter) ⭐ 1,448 | 🐛 36 | 🌐 Python | 📅 2026-09-09
* [check\_pve](https://github.com/nbuchwitz/check_pve) ⭐ 134 | 🐛 10 | 🌐 Python | 📅 2026-09-10 — Icinga/Nagios plugin to monitor Proxmox VE nodes, VMs, storage and cluster health.
...
* [proxmox-backup](https://github.com/tis24dev/proxmox-backup) ⭐ 520 | 🐛 3 | 🌐 Go | 📅 2026-09-08
...
* [PBS\_Chunk\_Checker](https://github.com/VoltKraft/PBS_Chunk_Checker) ⭐ 36 | 🐛 0 | 🌐 Python | 📅 2026-04-27
...
* [netbox-proxbox](https://github.com/netdevopsbr/netbox-proxbox) ⭐ 593 | 🐛 1 | 🌐 Python | 📅 2026-09-12 — NetBox plugin to sync and inventory Proxmox VE clusters, nodes and VMs.
* [CV4PVE-REPORT](https://github.com/Corsinvest/cv4pve-report) ⭐ 58 | 🐛 2 | 🌐 C# | 📅 2026-06-01 — Export Proxmox VE infrastructure to a navigable Excel report — like RVTools for Proxmox.
...
* [Proximo](https://github.com/john-broadway/proximo) ⭐ 43 | 🐛 1 | 🌐 Python | 📅 2026-09-13 — AI-driven natural-language assistant for managing Proxmox VE.
...
* [go-proxmox](https://github.com/luthermonson/go-proxmox) ⭐ 287 | 🐛 2 | 🌐 Go | 📅 2026-08-09
* [Packer Plugin for Proxmox VE](https://developer.hashicorp.com/packer/integrations/hashicorp/proxmox)

#### Terraform

* [terraform-provider-proxmox (Telmate)](https://github.com/Telmate/terraform-provider-proxmox) ⭐ 2,954 | 🐛 128 | 🌐 Go | 📅 2026-09-02

***

## Other Tools

* [Proxmox VE Helper-Scripts](https://github.com/community-scripts/ProxmoxVE) ⭐ 29,573 | 🐛 20 | 🌐 Shell | 📅 2026-09-13
* [ProxMenux](https://github.com/MacRimi/ProxMenux) ⭐ 2,973 | 🐛 9 | 🌐 TypeScript | 📅 2026-09-13
* [Terraform Provider for Proxmox](https://github.com/bpg/terraform-provider-proxmox) ⭐ 2,225 | 🐛 99 | 🌐 Go | 📅 2026-09-13
* [PVE-mods](https://github.com/Meliox/PVE-mods) ⭐ 1,912 | 🐛 21 | 🌐 Shell | 📅 2026-09-13
* [Proxmox-Enhanced-Configuration-Utility (PECU)](https://github.com/Danilop95/Proxmox-Enhanced-Configuration-Utility) ⭐ 972 | 🐛 10 | 🌐 Shell | 📅 2026-05-17
* [ProxLB](https://github.com/gyptazy/ProxLB) ⭐ 893 | 🐛 16 | 🌐 Python | 📅 2026-01-15
* [pvetui](https://github.com/devnullvoid/pvetui) ⭐ 722 | 🐛 17 | 🌐 Go | 📅 2026-09-07
* [Proxmox-GitOps](https://github.com/stevius10/Proxmox-GitOps) ⭐ 583 | 🐛 1 | 🌐 Ruby | 📅 2026-09-12 — GitOps workflow to manage Proxmox VE infrastructure declaratively.
* [proxmox-backup](https://github.com/tis24dev/proxmox-backup) ⭐ 520 | 🐛 3 | 🌐 Go | 📅 2026-09-08
* [Cluster API Provider for Proxmox VE (CAPMOX)](https://github.com/ionos-cloud/cluster-api-provider-proxmox) ⭐ 480 | 🐛 119 | 🌐 Go | 📅 2026-09-09
* [pve-microvm](https://github.com/rcarmo/pve-microvm) ⭐ 381 | 🐛 0 | 🌐 Shell | 📅 2026-09-05 — Run lightweight microVMs on Proxmox VE.
* [Proxmox VM Autoscale](https://github.com/fabriziosalmi/proxmox-vm-autoscale) ⭐ 304 | 🐛 1 | 🌐 Python | 📅 2026-09-12
* [osx-proxmox](https://github.com/lucid-fabrics/osx-proxmox-next) ⭐ 269 | 🐛 0 | 🌐 Python | 📅 2026-09-12 - One-command macOS VM automation for Proxmox 9 with TUI wizard, recovery auto-download, and AMD/Intel support.
* [LXC AutoScale](https://github.com/fabriziosalmi/proxmox-lxc-autoscale) ⭐ 259 | 🐛 15 | 🌐 Python | 📅 2026-09-07
* [lws](https://github.com/fabriziosalmi/lws) ⭐ 75 | 🐛 6 | 🌐 Python | 📅 2026-09-13 — Unified CLI for Proxmox, LXC, and Docker.
* [Proxmox Manager](https://github.com/TimInTech/proxmox-manager) ⭐ 72 | 🐛 1 | 🌐 Shell | 📅 2026-08-31 — CLI toolkit for common Proxmox VE administration tasks.
...
* [valheim-proxmox](https://github.com/PawelSzymanski89/valheim-proxmox) ⭐ 10 | 🐛 0 | 🌐 Python | 📅 2026-09-10 — One-command Valheim dedicated server in an LXC, with a web panel for players, bans, worlds, backups and mods.
...
* [TrueNAS SCALE Community Catalog](https://github.com/truecharts/apps) ⭐ 1,356 | 🐛 16 | 🌐 Go Template | 📅 2026-09-14
...
* [Darkmoon](https://github.com/ASCIT31/Dark-Moon) ⭐ 928 | 🐛 2 | 🌐 Python | 📅 2026-09-08 - Open source (GPL-3.0) autonomous AI penetration testing platform covering web, API, Active Directory and Kubernetes.
...
* [PVE Center](https://github.com/mcluremail/pvecenter) ⭐ 0 | 🐛 0 | 🌐 Python | 📅 2026-09-11 — Native desktop client for Proxmox VE: monitoring, VM/container management, backups and direct Proxmox Backup Server integration (PySide6, Windows and Linux).

***

## Documentation

* [Proxmox Hardening Guide](https://github.com/HomeSecExplorer/Proxmox-Hardening-Guide) ⭐ 561 | 🐛 0 | 📅 2026-02-09 — Actionable recommendations to secure Proxmox VE and Proxmox Backup Server.
